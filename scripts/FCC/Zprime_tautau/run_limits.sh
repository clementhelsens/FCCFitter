#!/bin/bash
#to run ./scripts/Zprime_tautau/run_limits.sh fcc_v02 _sel0mzp
#to run ./scripts/Zprime_tautau/run_limits.sh fcc_v02 _sel0mr
#to run ./scripts/Zprime_tautau/run_limits.sh fcc_v02 _sel1mzp
#to run ./scripts/Zprime_tautau/run_limits.sh fcc_v02 _mt
myversion=$1
sel=$2
for ene in 5 10 15 20 25 30;
do
