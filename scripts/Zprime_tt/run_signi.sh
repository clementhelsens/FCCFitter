...
=======
python python/significance.py -f "config_FCC/Zprime_tt/fcc_v02/cut/Zprime_sel0_*TeV.config" -n Zprime_tt_fcc_v02_cut
python python/significance.py -f "config_FCC/Zprime_tt/fcc_v02/cut_TRFbtag/Zprime_sel0_*TeV.config" -n Zprime_tt_fcc_v02_cut_TRFbtag
